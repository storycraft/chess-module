...
export class PlayCommand implements CommandInfo {

    constructor(private chessManager: ChessManager) {
...
export class CreateCommand implements CommandInfo {
    ...
    onCommand(e: BotCommandEvent, logger: ModuleLogger) {
        ...
        setTimeout(() => { if (!game.Started) { this.chessManager.removeGame(game.Id); } }, 60 * 1000);
...
export class CustomCreateCommand implements CommandInfo {
...
export class StatCommand implements CommandInfo {
...
export class SpecCommand implements CommandInfo {
...
export class UnSpecCommand implements CommandInfo {
...
export class BoardCommand implements CommandInfo {
