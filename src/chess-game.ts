...
export class ChessGame {
    ...
    public static readonly BOARD_IMG =  `${__dirname}/../resources/chessboard.png`;
    public static readonly PIECES_SPRITE_IMG = `${__dirname}/../resources/chess_pieces.png`;
    public static readonly OVERLAY_IMG = `${__dirname}/../resources/chessoverlay.png`;
    public static readonly HIGHLIGHT_IMG = `${__dirname}/../resources/highlight.png`;
