...
ChessGame.BOARD_IMG = `${__dirname}/../chess-module/resources/chessboard.png`;
ChessGame.PIECES_SPRITE_IMG = `${__dirname}/../chess-module/resources/chess_pieces.png`;
ChessGame.OVERLAY_IMG = `${__dirname}/../chess-module/resources/chessoverlay.png`;
ChessGame.HIGHLIGHT_IMG = `${__dirname}/../chess-module/resources/highlight.png`;
